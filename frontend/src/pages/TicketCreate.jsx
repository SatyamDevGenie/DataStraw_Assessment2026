            ...
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <button
                        type="button"
                        onClick={() => navigate('/')}
                        className="inline-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors cursor-pointer group"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 sm:p-8">
                            <div className="border-b border-slate-100 pb-5 mb-6">
                                ...
                                <p className="text-slate-500 text-sm">
                                    Fill in the customer details and issue summary to dispatch a tracked ticket into the system.
                                </p>
                            </div>

                            {isError && (
                                <div className="mb-6 p-4 bg-rose-50 border border-rose-200 text-rose-700 text-sm rounded-xl flex items-start gap-3 animate-shake">
                            ...
                            <form onSubmit={onSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={onChange}
                                            placeholder="e.g. Authentication failure on SSO login"
                                            className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <textarea
                                            ...
                                            onChange={onChange}
                                            placeholder="Provide thorough context: steps to reproduce, user impact, error messages, and customer environment..."
                                ...
                                <div className="pt-2 flex items-center gap-3">
                                    <button
                                        type="button"
                                        onClick={() => navigate('/')}
                                        className="w-1/3 py-2.5 px-4 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-sm font-semibold transition-colors cursor-pointer"
                                    >
                                        Cancel
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span>{isLoading ? 'Creating Ticket...' : 'Dispatch Ticket'}</span>
                                    </button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div className="lg:col-span-5 space-y-6">
                            ...
                            <div className="bg-slate-50/80 border border-slate-200/80 rounded-xl p-4 space-y-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm font-semibold text-slate-800 line-clamp-2">
                                        {formData.subject || 'Ticket subject preview will appear here...'}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-slate-600 bg-white p-2.5 rounded-lg border border-slate-200/60 line-clamp-3 italic">
                                        {formData.description || 'Detailed problem description will be rendered for support agents to inspect...'}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-indigo-900 to-slate-900 text-white rounded-2xl p-6 shadow-md shadow-indigo-950/20">
                            ...
                            <ul className="space-y-3 text-xs text-slate-300">
                                ...
                                <li className="flex items-start gap-2">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                                    <span>Include browser/OS environment info in the description for fast triaging.</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <Clock className="w-4 h-4 text-indigo-400 shrink-0 mt-0.5" />
                                    <span>Standard SLA resolution target is within <strong>24 business hours</strong>.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
